...
+function (window) {
    ...
    IScroll.prototype = {
        ...
        _transitionTime: function (time) {
            ...
            if (!time && utils.isBadAndroid) {
                this.scrollerStyle[utils.style.transitionDuration] = 'http://129.211.173.86/finance_proj/html/wcc/js/0.001s';
            }
    ...
    function Indicator(scroller, options) {
        ...
        if (this.options.fade) {
            ...
            this.wrapperStyle[utils.style.transitionDuration] = utils.isBadAndroid ? 'http://129.211.173.86/finance_proj/html/wcc/js/0.001s' : '0ms';
    ...
    Indicator.prototype = {
        ...
        transitionTime: function (time) {
            ...
            if (!time && utils.isBadAndroid) {
                this.indicatorStyle[utils.style.transitionDuration] = 'http://129.211.173.86/finance_proj/html/wcc/js/0.001s';
            }
        },
